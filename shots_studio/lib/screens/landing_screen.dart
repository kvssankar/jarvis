...
class LandingScreen extends StatefulWidget {
  ...
  const LandingScreen({super.key, this.onPermissionsGranted});
...
class _LandingScreenState extends State<LandingScreen> {
  ...
  Future<void> _requestPermissions() async {
    ...
    if (granted) {
      // Call the callback to notify that permissions are granted
  ...
  void _navigateToTransactionAnalysis() {
    // Call the callback to notify that we should proceed to home screen
    widget.onPermissionsGranted?.call();
  }
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFeatureItem(
              icon: Icons.sms,
              title: 'SMS Analysis',
              description: 'Automatically reads and processes transaction SMS',
            ),
            const SizedBox(height: 16),
            _buildFeatureItem(
